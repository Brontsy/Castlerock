...
var HeaderImage = new Class({
	...
	initialize: function(images){
        ...
        this._images.push(new Asset.image('http://castlerockproperty.blob.core.windows.net/castlerock/images/homepage/12.jpg', { id: 'image2', title: 'myImage', onload: this.imageLoaded.bind(this) }));
        ...
        this._images.push(new Asset.image('http://castlerockproperty.blob.core.windows.net/castlerock/images/homepage/13.jpg', { id: 'image2', title: 'myImage', onload: this.imageLoaded.bind(this) }));
